...
import oAuth.basic.UrlStringRequestAdapter;
import oAuth.exception.OAuthCommunicationException;
import oAuth.exception.OAuthExpectationFailedException;
import oAuth.exception.OAuthMessageSignerException;
import oAuth.http.HttpParameters;
import oAuth.http.HttpRequest;
import oAuth.signature.AuthorizationHeaderSigningStrategy;
import oAuth.signature.HmacSha1MessageSigner;
import oAuth.signature.OAuthMessageSigner;
import oAuth.signature.QueryStringSigningStrategy;
import oAuth.signature.SigningStrategy;

/**
 * ABC for consumer implementations. If you're developing a custom consumer you
 * will probSSSably inherit from this class to save you a lot of work.
 *
